...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeguridadInformatica.Models.Amenzas", b =>
                {
                    b.Property<int>("AmenazasId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AmenazasId"), 1L, 1);
                    ...
                    b.Property<int?>("DimensionesActivosId")
                        .HasColumnType("int");

                    b.Property<string>("DimensionesId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Imacto")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("DimensionesActivosId");
            ...
            modelBuilder.Entity("SeguridadInformatica.Models.Amenzas", b =>
                {
                    ...
                    b.HasOne("SeguridadInformatica.Models.Activos", "Dimensiones")
                        .WithMany()
                        .HasForeignKey("DimensionesActivosId");
